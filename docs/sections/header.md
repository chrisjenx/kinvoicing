...
See [Branding & Logos](../styling/branding) for logo setup, dual branding, and layout options.
...
{% include example-preview.html name="section-header-horizontal" height="250px" %}
...
{% include example-preview.html name="section-header-stacked" height="250px" %}
...
{% include example-preview.html name="section-header-dual-branding" height="250px" %}
