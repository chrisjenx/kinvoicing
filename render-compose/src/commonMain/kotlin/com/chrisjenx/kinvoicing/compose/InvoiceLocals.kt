...
public val LocalImageRenderer: ProvidableCompositionLocal<@Composable (source: ImageSource, width: Int?, height: Int?, altText: String?) -> Unit> =
    compositionLocalOf { defaultImageRenderer() }

internal expect fun defaultImageRenderer(): @Composable (source: ImageSource, width: Int?, height: Int?, altText: String?) -> Unit
